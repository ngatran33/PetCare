    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.epBtnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                presenterEditPost.save(loai, mota,flag,mUri,idPost,status.getImg(),date);
            }
        });
    }
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if(user!=null){
                                ...
                                if(status.getImg().equals("default")){
                                    binding.epimgHien.setVisibility(View.GONE);
                                }else{
                                    binding.epimgHien.setVisibility(View.VISIBLE);
